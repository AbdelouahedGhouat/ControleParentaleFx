...
public class NotifEvent implements Serializable {
    ...
    public NotifEvent(Etudiant etudiant, Evenement evenement) {
    ...
    public NotifEvent(Etudiant etudient, Evenement evenement, Date dateLecture, String description) {
        this.etudiant = etudient;
        this.evenement = evenement;
